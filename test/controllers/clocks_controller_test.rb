...
class ClocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clock" do
    assert_difference('Clock.count') do
      post clocks_url, params: { clock: { clocked_in: @clock.clocked_in, user_id: @clock.user_id } }
    end
  ...
  test "should update clock" do
    patch clock_url(@clock), params: { clock: { clocked_in: @clock.clocked_in, user_id: @clock.user_id } }
